...
const ControlsTooltipModule = function (fvdSynchronizer) {
  ...
  ToolTip.prototype = {
    ...
    close: function (callback) {
      ...
      fvdSynchronizer.Controls.ToolTip._container.addEventListener(
        'webkitTransitionEnd',
        function () {
          try {
            fvdSynchronizer.Controls.ToolTip._container.parentNode.removeChild(
              fvdSynchronizer.Controls.ToolTip._container
            );
  ...
  fvdSynchronizer.Controls.ToolTip = new ToolTip();
};

export default ControlsTooltipModule;
