...
const ControlsTabsModule = function (fvdSynchronizer) {
  fvdSynchronizer.Controls.Tabs = {
    tabs: [],
    tabsByIds: {},
      ...
      var TabBox = function (tabsBox) {
        ...
        this.getActiveTabElem = function () {
          return document.querySelector(
            '#' + tabsBox.getAttribute('id') + ' > .tabsHead > .tabHead[active]'
          );
        };
        ...
        function tabsContent() {
          return document.querySelectorAll(
            '#' + tabsBox.getAttribute('id') + ' > .tabsData > .tabContent'
          );
        }

        function tabsHeads() {
          return document.querySelectorAll(
            '#' + tabsBox.getAttribute('id') + ' > .tabsHead > .tabHead'
          );
        }
  ...
  fvdSynchronizer.addEventListener(
    EventType.LOAD,
    function () {
      fvdSynchronizer.Controls.Tabs.init();
    },
    false
  );
};

export default ControlsTabsModule;
