...
const PrefsModule = function (fvdSynchronizer) {
  const localStorage = fvdSynchronizer.localStorage;
  ...
  Prefs.prototype = {
    ...
    set: function (name, value) {
      ...
      if (_r(oldValue) != _r(value)) {
        localStorage.setItem(this._name(name), value);
  ...
  fvdSynchronizer.Prefs = new Prefs();
};
