...
export const SimpleBench = function (start) {
...
// extends
const UtilsModule = function (fvdSynchronizer) {
  var Utils = function () {};
  Utils.prototype = {
    ...
    copyToClipboard: function (text) {
      const clipboardholder = document.getElementById('clipboardholder');
  ...
  fvdSynchronizer.Utils = new Utils();
  (function () {
    var DD = function () {};
    ...
    fvdSynchronizer.DD = new DD();
  }.apply(fvdSynchronizer.Utils));
};
